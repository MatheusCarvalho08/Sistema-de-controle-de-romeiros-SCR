<?php 
  ...
  $sql = "SELECT * FROM usuarios ORDER BY id DESC";  //Seleciona a tabela usuarios dentro do nosso banco
  $result = $conexao->query($sql);

// Inicia ou retoma uma sessão existente
  session_start();
// Se o usuário não estiver logado, desconfigura (unset) as variáveis de sessão 'id' e 'senha'  
