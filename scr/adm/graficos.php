...
<script>
      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Número de pessoas que fazem as peregrinações em cada ano',
            data: [310000,300000,100000,200000,320000,330000],
            borderWidth: 1
          }]
        },
        options: {
