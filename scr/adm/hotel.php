<?php 
  ...
  $sql = "SELECT * FROM hotel ORDER BY id DESC";  //Seleciona a tabela hotel dentro do nosso banco
...
<html lang="en">
  <head>
    ...
    <title>Página de Cadastro dos Hotéis/Pousadas</title>
    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <h2>PÁGINA DE CADASTRO DOS HOTÉIS</h2>
        </div>
        <div class="m-5">
        <table class="table text-white table-bg">
              <thead>
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">Nome do Hotel/Pousada</th>
              ...
              <tbody>
                  <?php 
                    while($user_data = mysqli_fetch_assoc($result)) // Inicia um loop enquanto houver dados para buscar do banco de dados
                    {
                        ...
                        echo "<td>".$user_data['nomehotel']."</td>";
