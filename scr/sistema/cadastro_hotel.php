...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO hotel(nomehotel,cidade,km,telefone,email,seunome) VALUES ('$nomehotel','$cidade','$km','$telefone','$email','$seunome')");
}
...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro_hotel.css">
    <title>Cadastro dos Hotéis/Pousadas</title>
...
<body>
    ...
    <center><div class="container">
        <div class="form-image">
            <img src="imgs/undraw_mobile_content_xvgr.svg" alt="">
        </div>
        <div class="form">
            <form action="#" method="POST">
                <div class="form-header">
                    <div class="title">
                        <h1>Cadastre o seu Hotel/Pousada</h1>
                    </div>
                </div>
<br><br>
                <div class="input-group">
                    <div class="input-box">
                        <label for="nomehotel">Nome do Hotel/Pousada</label>
                        <input id="nomehotel" type="text" name="nomehotel" placeholder="Nome" required>
                    </div>
            
                    <div class="input-box">
                        <label for="cidade">Cidade do Hotel/Pousada</label>
...
<br><br><br>
                <div class="continue-button">
                    <input type="submit" name="submit" id="submit" value="Cadastrar" onclick="cadastro_hotel()">
                </div>
            </form>
        </div>
    </div></center>
...
<script>
    function cadastro_hotel(){
       alert('Seu Hotel foi cadastrado com Sucesso!');
    }
</script>  
